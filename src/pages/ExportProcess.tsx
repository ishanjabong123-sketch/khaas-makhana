        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mb-16">
              <Badge variant="outline" className="mb-4">Export Process</Badge>
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Our streamlined export process ensures premium quality makhana reaches international 
                buyers with complete traceability and compliance.
              </p>
            </div>
            ...
            <Card className="bg-secondary/50 mb-16">
              <CardHeader className="text-center">
                ...
                <p className="text-muted-foreground">
                  All our exports are backed by international quality certifications
                </p>
              </CardHeader>
              <CardContent>
            ...
            <div className="grid md:grid-cols-4 gap-6 mb-16">
              ...
              <Card className="text-center">
                <CardContent className="pt-6">
                  ...
                  <div className="text-muted-foreground">Tons Annual Export</div>
                </CardContent>
              </Card>
              <Card className="text-center">
                <CardContent className="pt-6">
                  <div className="text-3xl font-bold text-primary">99.8%</div>
                  <div className="text-muted-foreground">Quality Success Rate</div>
                </CardContent>
              </Card>
              <Card className="text-center">
                <CardContent className="pt-6">
            ...
            <Card className="bg-gradient-to-r from-primary/10 to-accent/10 border-none">
              <CardContent className="text-center py-12">
                <h3 className="text-2xl font-bold mb-4">Ready to Start Exporting?</h3>
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Partner with us for reliable, high-quality makhana exports. Our experienced team 
